...
if(isset($_REQUEST['cat_add'])){
  ...
  $dup=mysqli_execute("select * from service_catagory where Ser_CategoryName='$name' OR Ser_CategoryId=$id");
  
  
  if(mysqli_num_rows($dup)>0)
  {
    echo "Service category is already Exists...Please Enter New";
  ...
  else
  {
    ...
    $que="insert into service_catagory values('$id','$name',$sid)";
...
$r=$crud->getdata("select * from services;");
...
<!-- Example Tables Card -->
        <div class="card mb-3">
          ...
          <div class="card-header">
            <a href="cat_tb.php">View Table </a>
          </div>
        ...
        <!--<input type="hidden" name="post" value="Send" />-->
              ...
              <label for="name">Service Catagory Id:</label> <br>
              ...
              <label for="text">Service Catagory Name:</label> <br>
              ...
              <input type="submit" class="submit_btn" name="cat_add" id="submit" value="Add"/>
