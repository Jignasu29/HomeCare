...
$res=$crud->getData("select * from service_catagory;");
...
<!-- Example Tables Card -->
        <div class="card mb-3">
          <div class="card-header">
            ...
            Service Catagory Table
          </div>

          <div class="card-header">
            <a href="cat_add.php">Add Item</a>
          </div>
                ...
                <tbody>
                  <?php
                    ...
                    {     
                      ...
                      echo "<td>".$r["Ser_CatagoryName"]."</td>";
                      echo "<td>".$r["Service_ID"]."</td>";
                  ?>
                      <td><a href="cat_edit.php?id=<?php echo $r['Ser_CatagoryId'] ?>">Edit</a></td>
                     <td><a href="cat_del.php?id=<?php echo $r['Ser_CatagoryId']?>"  onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                  <?php
                      echo "</tr>";
                      }
                  ?>
