...
$res=$crud->getData("select * from ragistration;");
                ...
                <tbody>
                  <?php
                    ...
                    {     
                      ...
                      echo "<td>".$r["Customer_EmailId"]."</td>";
                      //echo "<td>".$r["Customer_MobileNo"]."</td>";
                      //echo "<td>".$r["Customer_Password"]."</td>";
                      echo "<td>".$r["Customer_Gender"]."</td>";
                      echo "<td>".$r["Customer_Address"]."</td>";
                      echo "<td>".$r["Customer_Pincode"]."</td>";
                      echo "<td>".$r["Customer_City"]."</td>";
                      //echo "<td>".$r["Customer_State"]."</td>";
                  ?>
                      <td><a href='rg_edit.php?id=<?php echo $r["Customer_EmailId"] ?>'>Edit</a></td>
                      <td><a href="rg_del.php?id=<?php echo $r['Customer_EmailId']?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                  <?php
                        echo "</tr>";
                    }
                  ?>
