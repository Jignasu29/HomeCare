...
$res=$crud->getData("select * from services;");
            ...
            <a href="ser_add.php">Add Item</a>
              ...
              <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                ...
                <tbody>
                  ...
                  ?>
                      <td><a href="ser_edit.php?id=<?php echo $r['Service_ID'] ?>">Edit</a></td>
                     <td><a href="ser_del.php?id=<?php echo $r['Service_ID']?>"  onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                  <?php
                      echo "</tr>";
                      }
                  ?>
