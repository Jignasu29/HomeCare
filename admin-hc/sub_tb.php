...
$res=$crud->getData("select * from service_subcatagory;");
...
<!-- Example Tables Card -->
        <div class="card mb-3">
          <div class="card-header">
            ...
            Service Subcatagory Table
          </div>

          <div class="card-header">
            <a href="sub_add.php">Add Item</a>
          </div>
              ...
              <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                ...
                <tbody>
                  <?php
                    ...
                    {     
                      echo "<tr>";
                      echo "<td>".$r["Ser_SubCatagoryId"]."</td>";
                      echo "<td>".$r["Ser_SubCatgoryName"]."</td>";
                      echo "<td>".$r["Ser_CatagoryId"]."</td>";
                      echo "<td>".$r["Price"]."</td>";
                  ?>
                      <td><a href="sub_edit.php?id=<?php echo $r['Ser_SubCatagoryId'] ?>">Edit</a></td>
                     <td><a href="sub_del.php?id=<?php echo $r['Ser_SubCatagoryId']?>"  onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                  <?php
                      echo "</tr>";
                      }
                  ?>
