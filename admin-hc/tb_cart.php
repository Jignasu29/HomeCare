...
$res=$crud->getData("select * from cart;");
            ...
            <div class="table-responsive">
              <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                <thead>
                  <tr>
                    <th>Id</th>
                    <th>Service Subcatagory Id</th>
                    <th>Service Subcatagory Name</th>
                    <th>Quantity</th>
                    <th>Price</th>
                    <th>User's Email</th>
                    <th>Accept</th>
                ...
                <tbody>
                  ...
                  ?>
                      <td><a href='accept.php?cid=<?php echo $r["Id"]?>&eid=<?php echo $r["Customer_EmailId"]?>'>Accept</a></td>
                     <td><a href='decline.php?cid=<?php echo $r["Id"]?>&eid=<?php echo $r["Customer_EmailId"]?>' onclick="return confirm('Are you sure you want to decline this request?')">Decline</a></td>
