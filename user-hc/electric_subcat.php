...
<?php	
 ...
 $ser=array("Fan","Lights","MCB & Fuse","Geyser","Switches & Spckets");
for($x=0;$x<count($ser);$x++)
{


	$sid="select Ser_catagoryID from service_catagory where Ser_catagoryName='$ser[$x]'";
	//echo $id."<br/>";
	$res1=mysqli_query($con,$sid) or die(mysqli_error($con));
...
<form name="item_list" method="POST">
	<h2> <?php echo $ser[$x];?> Services</h2>
	<table  border="5" align="center" width="100%" cellpadding="10">
					<tr> 
				...
				<?php
					...
					<td><a href='addtocart.php?id=<?php echo $r["Ser_SubCatagoryId"]; ?>&name=<?php echo $r["Ser_SubCatgoryName"];?>&price=<?php echo $r["Price"];?>&qty=<?php echo $_POST["qty"]?>'>Add to cart</td>;
