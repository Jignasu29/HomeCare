...
<?php
	...
	$ser=array("Washing Machine","AC","TV","Microwave Owen","Refrigerator");
...
<form name="item list" method="POST">
	<h2><?php echo $ser[$x];?> Services</h2>
					...
					<td><a href='addtocart2.php?id1=<?php echo $r["Ser_SubCatagoryId"]; ?>&name1=<?php echo $r["Ser_SubCatgoryName"];?>&price1=<?php echo $r["Price"];?>&qty1=<?php echo $_POST["qty"]?>' >Add to cart</td>;
